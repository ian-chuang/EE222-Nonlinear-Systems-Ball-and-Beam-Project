...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } ObserverResults_PWORK;             /* '<Root>/Observer Results' */
...
struct P_simulink_experiment_debug_t_T_ {
  ...
  uint32_T HILWriteAnalog_channels;   /* Mask Parameter: HILWriteAnalog_channels
                                       ...
                                       */
  real_T MATLABSystem_Q_tvlqr[16];     /* Expression: diag( [ 100, 0, 0, 0 ] )
                                        * Referenced by: '<Root>/MATLAB System'
                                        */
  real_T MATLABSystem_R_tvlqr;         /* Expression: diag( [ 0.3 ] )
                                        * Referenced by: '<Root>/MATLAB System'
                                        */
  real_T MATLABSystem_X_prior[4];      /* Expression: [ -0.19; 0; 0; 0 ]
                                        * Referenced by: '<Root>/MATLAB System'
                                        */
  real_T MATLABSystem_V_servo;         /* Expression: 0.0
                                        * Referenced by: '<Root>/MATLAB System'
                                        */
  real_T MATLABSystem_initialState[4]; /* Expression: [ -0.19; 0.00; 0; 0 ]
                                        * Referenced by: '<Root>/MATLAB System'
                                        */
