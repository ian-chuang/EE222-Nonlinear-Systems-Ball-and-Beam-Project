    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(28)  = dumData; %prealloc
                    ...
                    ;% simulink_experiment_debug_typ_P.MATLABSystem_Q_tvlqr
                    section.data(1).logicalSrcIdx = 2;
                    section.data(1).dtTransOffset = 0;

                    ;% simulink_experiment_debug_typ_P.MATLABSystem_R_tvlqr
                    section.data(2).logicalSrcIdx = 3;
                    section.data(2).dtTransOffset = 16;

                    ;% simulink_experiment_debug_typ_P.MATLABSystem_X_prior
                    section.data(3).logicalSrcIdx = 4;
                    section.data(3).dtTransOffset = 17;

                    ;% simulink_experiment_debug_typ_P.MATLABSystem_V_servo
                    section.data(4).logicalSrcIdx = 5;
                    section.data(4).dtTransOffset = 21;

                    ;% simulink_experiment_debug_typ_P.MATLABSystem_initialState
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(11)  = dumData; %prealloc
                    ...
                    ;% simulink_experiment_debug_ty_DW.ObserverResults_PWORK.LoggedData
    ...
    targMap.checksum0 = 2026849503;
    targMap.checksum1 = 3021995234;
    targMap.checksum2 = 192163238;
    targMap.checksum3 = 3525489453;
