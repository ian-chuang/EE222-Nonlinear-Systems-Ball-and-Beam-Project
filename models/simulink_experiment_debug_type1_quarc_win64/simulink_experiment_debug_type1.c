 ...
 * C source code generated on : Wed Apr 23 12:29:58 2025
 *
...
void simulink_experiment_debug_type1_output0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  z4 = (((((108077.0 * z4 * a_ball_ref / 4.0E+8 + 108077.0 * g * p_ball_ref /
            1.0E+7) - 127.0 * amplitude * g * K / 2500.0) + 127.0 * omega * g *
          b_x / 200000.0) - 127.0 * amplitude * hat_y_idx_0 * b_x_0 / 100000.0)
  ...
  z4 = (((((((((((((((5.37476460632559E+14 * z4 * br / 6.4E+17 +
             ...
             amplitude * c_8 * c_9 / 2.5E+12) + 8.1764465503E+10 * omega * c_a *
            c_b / 1.0E+14) + 8.1764465503E+10 * amplitude * c_c * c_d / 4.0E+15)
          - 2.60144641E+8 * amplitude * c_e * c_f / 2.0E+16) - 8.1764465503E+10 *
         amplitude * c_g * x / 8.0E+13) + 8.1764465503E+10 * omega * c_h * x_0 /
        8.0E+15) * 4.0E+9 / ((((((324231.0 * c_i * b_x / 4.0E+8 + 108077.0 * g *
    b_x_0 / 5.0E+6) - 127.0 * amplitude * g * b_x_1 / 1250.0) + 127.0 * omega *
    g * b_x_2 / 100000.0) - 381.0 * amplitude * c_j * b_x_3 / 100000.0) +
...
RT_MODEL_simulink_experiment__T *simulink_experiment_debug_type1(void)
{
  ...
  /* External mode info */
  simulink_experiment_debug_ty_M->Sizes.checksums[0] = (3093214479U);
  simulink_experiment_debug_ty_M->Sizes.checksums[1] = (4172872463U);
  simulink_experiment_debug_ty_M->Sizes.checksums[2] = (2210210177U);
  simulink_experiment_debug_ty_M->Sizes.checksums[3] = (2914068788U);
