...
#include "rtwtypes.h"
#ifndef struct_tag_mcIscseMVxK6urDpjPtTqF
#define struct_tag_mcIscseMVxK6urDpjPtTqF

struct tag_mcIscseMVxK6urDpjPtTqF
{
  real_T t_prev;
  real_T K[4];
  real_T x_hat[4];
...
#endif                                 /* struct_tag_mcIscseMVxK6urDpjPtTqF */

#ifndef typedef_studentControllerInterface_si_T
#define typedef_studentControllerInterface_si_T

typedef struct tag_mcIscseMVxK6urDpjPtTqF studentControllerInterface_si_T;
